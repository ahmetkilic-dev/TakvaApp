...
const badgeTasks = [
  {
    ...
    iconKey: 'kuran',
    tasks: [
      { id: 1, text: 'Toplam 50 ayet oku.', label: 'Adım', icon: 1, progress: 0 },
      { id: 2, text: 'Toplam 250 ayet oku.', label: 'Süreç', icon: 2, progress: 0 },
      { id: 3, text: 'Toplam 1.000 ayet oku.', label: 'İlerleme', icon: 3, progress: 0 },
      { id: 4, text: 'Toplam 15 cüz tamamla.', label: 'Cüz', icon: 4, progress: 0 },
      { id: 5, text: '80 farklı sureyi bitir.', label: 'Sure', icon: 5, progress: 0 },
      { id: 6, text: 'Toplam 5.000 ayet oku.', label: 'Nur', icon: 6, progress: 0 },
      { id: 7, text: 'Kur\'ân\'ı baştan sona hatim et.', label: 'Hikmet', icon: 7, progress: 0 },
    ],
  },
  {
    ...
    iconKey: 'namaz',
    tasks: [
      { id: 8, text: 'Bir gün boyunca tüm vakitleri kıl ve işaretle.', label: 'Vakit', icon: 1, progress: 0 },
      { id: 9, text: '7 gün boyunca hiçbir vakti boş bırakma.', label: 'Düzen', icon: 2, progress: 0 },
      { id: 10, text: '30 gün boyunca günlük namazlarını işaretle.', label: 'İstikrar', icon: 3, progress: 0 },
      { id: 11, text: 'Toplam 100 vakit namaz kıl ve işaretle.', label: 'Huzur', icon: 4, progress: 0 },
      { id: 12, text: 'Yıl içinde en az 200 vakit işaretle.', label: 'Sabır', icon: 5, progress: 0 },
      { id: 13, text: 'Toplam 1.000 namaz vakti işaretle.', label: 'Sükûnet', icon: 6, progress: 0 },
      { id: 14, text: 'Toplam 2.500 vakit namaz kıl ve işaretle.', label: 'İhsan', icon: 7, progress: 0 },
    ],
  },
  {
    ...
    iconKey: 'zksl',
    tasks: [
      { id: 15, text: 'Toplam 100 zikir veya salavat yap.', label: 'Niyet', icon: 1, progress: 0 },
      { id: 16, text: 'Toplam 500 zikir veya salavat yap.', label: 'Adanış', icon: 2, progress: 0 },
      { id: 17, text: 'Toplam 1.000 zikir veya salavat yap.', label: 'Teskin', icon: 3, progress: 0 },
      { id: 18, text: 'Toplam 5.000 zikir veya salavat yap.', label: 'Sabr', icon: 4, progress: 0 },
      { id: 19, text: 'Toplam 10.000 zikir veya salavat yap.', label: 'Sevda', icon: 5, progress: 0 },
      { id: 20, text: 'Toplam 25.000 zikir veya salavat yap.', label: 'Rahmet', icon: 6, progress: 0 },
      { id: 21, text: 'Toplam 50.000 zikir veya salavat yap.', label: 'Feyz', icon: 7, progress: 0 },
    ],
  },
  {
    ...
    iconKey: 'ilim',
    tasks: [
      { id: 22, text: '5 soruyu doğru cevapla.', label: 'Kıvılcım', icon: 1, progress: 0 },
      { id: 23, text: '15 soruyu doğru cevapla.', label: 'Araştırma', icon: 2, progress: 0 },
      { id: 24, text: '30 soruyu doğru cevapla.', label: 'Tahkik', icon: 3, progress: 0 },
      { id: 25, text: '50 soruyu doğru cevapla.', label: 'Marifet', icon: 4, progress: 0 },
      { id: 26, text: '100 soruyu doğru cevapla.', label: 'Hikmet', icon: 5, progress: 0 },
      { id: 27, text: '200 soruyu doğru cevapla.', label: 'İdrak', icon: 6, progress: 0 },
      { id: 28, text: '500 soruyu doğru cevapla.', label: 'İrfan', icon: 7, progress: 0 },
    ],
  },
  {
    ...
    iconKey: 'uygulama',
    tasks: [
      { id: 29, text: 'Kelam\'daki bir içeriği ilk kez paylaş.', label: 'Davet', icon: 1, progress: 0 },
      { id: 30, text: 'Toplam 10 içerik paylaş.', label: 'Tebliğ', icon: 2, progress: 0 },
      { id: 31, text: 'Takva\'nın resmi sosyal medya hesaplarını takip et', label: 'Destek', icon: 3, progress: 0 },
      { id: 32, text: '10 içerik üreticisini takip et.', label: 'Cemiyet', icon: 4, progress: 0 },
      { id: 33, text: '3 gün üst üste uygulamaya giriş yap.', label: 'Süreklilik', icon: 5, progress: 0 },
      { id: 34, text: '30 gün boyunca düzenli giriş yap.', label: 'Sadakat', icon: 6, progress: 0 },
      { id: 35, text: 'Uygulamaya mağazada puan ver / yorum yap.', label: 'Minnet', icon: 7, progress: 0 },
    ],
  },
];
